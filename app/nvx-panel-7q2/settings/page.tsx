    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20, maxWidth: 1180 }}>
      ...
      <div className="cms-grid-collapse" style={{ display: 'grid', gridTemplateColumns: 'minmax(0,1fr) minmax(0,1fr)', gap: 18 }}>
        ...
        <Panel i={2}>
          ...
          <Link href="/nvx-panel-7q2/media" className="cms-btn cms-btn-ghost" style={{ alignSelf: 'flex-start', height: 34 }}>Open Media Library →</Link>
        </Panel>
      ...
      <Panel i={4}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 10 }}>
          {[
            { label: 'Site content', href: '/nvx-panel-7q2/content', hint: 'About · contact · social' },
            { label: 'Page editors', href: '/nvx-panel-7q2/pages/home', hint: 'Home · about · careers…' },
            { label: 'Media library', href: '/nvx-panel-7q2/media', hint: 'Uploads & assets' },
            { label: 'Enquiries', href: '/nvx-panel-7q2/contacts', hint: 'Leads & messages' },
          ].map((q) => (
